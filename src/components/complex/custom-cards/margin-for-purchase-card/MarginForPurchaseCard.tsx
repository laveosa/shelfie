              ...
              <div className={cs.marginDetailsItems}>
                <div className={cs.marginDetailsItem}>
                  ...
                  <span className="she-subtext">
                    ...
                    percentages do not intersect with it, but they result in
                    single total
                  </span>
                </div>
                <div className={cs.marginDetailsItem}>
                  ...
                  <span className="she-subtext">
                    ...
                    to eventually reduce. For example, you can add 20 pln to the
                    price of an item, so later, you could reduce the price
                    automatically up to this amount. If you don’t want to budget
                    for discount, just leave the field empty.
                  </span>
                </div>
                <div className={cs.marginDetailsItem}>
                  <SheInput
                  ...
                  <span className="she-subtext">
                    ...
                    are for example cost of package, or fraction of the shipping
                    fee. If you don’t want to count that in, leave the field
                    empty.
                  </span>
                </div>
                <div>
